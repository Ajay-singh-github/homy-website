...
const cuisines: CuisineType[] = [
  { name: "Indian", className: "col-start-2" },
  { name: "Italian", className: "col-start-3" },
  { name: "Chinese", className: "col-start-4" },
  { name: "Mexican", className: "col-start-2" },
  { name: "Thai", className: "col-start-3" },
  { name: "Japanese", className: "col-start-4" },
  { name: "French", className: "col-start-2 col-span-2" },
  { name: "and many more", className: "col-start-4" },
];
    ...
    <div className="relative min-h-[600px] flex items-center justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-16 relative z-10">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="absolute left-4 md:left-0 top-1/3 transform -translate-y-1/2">
          ...
          <div className="absolute right-4 md:right-0 top-2/3 transform -translate-y-1/2">
            ...
            {cuisines.map((cuisine, index) => (
              <Card
                ...
                className={`bg-white shadow-lg hover:shadow-xl transition-shadow 
                  px-6 py-3 text-center ${cuisine.className}`}
              >
                {cuisine.name}
              </Card>
            ))}
